...
export default class WinrateTab extends Component {
    ...
    render() {
        ...
        const currentData = this.state.data[this.state.dataType][this.state.currentLeague];
        ...
        return (
            <section id="winrate">
                ...
                <span className="all-controls">
                    <Tippy
                        content={`Counts all matches played by ${this.state.currentLeague} players`}
                        arrow="true"
                    >
                        <h4>All</h4>
                    </Tippy>
                    <Tippy
                        content={`Only counts matches played between 2 ${this.state.currentLeague} players`}
                        arrow="true"
                    >
                        <h4>League</h4>
                    </Tippy>
                    <label className="switch">
                        <input type="checkbox" onClick={() => this.changeDataType()} />
